...
from app.api.catalog_admin_delete import router as catalog_admin_delete_router
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    application.include_router(catalog_admin_delete_router, prefix=resolved_settings.api_prefix)
